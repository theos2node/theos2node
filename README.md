...
📍 **United States** | 💻 **Software Engineer** | 📱 **Mac & iOS Developer**

Actively building and maintaining open-source software and running BarsBookkeeper.
...
🍸 [**BarsBookkeeper**](https://barsbookkeeper.com/) - Automated bar inventory, forecasting, and ordering<br/>🍎 [**apple-steam**](https://github.com/theos2node/apple-steam) - SteamOS for M-series iPad<br/>📡 [**StreetPass for iOS**](https://github.com/theos2node/sidepass-ios) - Local-first Bluetooth encounters for iOS<br/>🏠 [**Homebridge LLM Control**](https://github.com/theos2node/homebridge-llm-control) - Guardrailed natural-language control for Homebridge<br/>🧠 [**no-mans-ai**](https://github.com/theos2node/no-mans-ai) - Observable LLM office simulation<br/>🎙️ [**Full Whisper Dictation for Mac**](https://github.com/theos2node/Full-Whisper-Dictation-for-Mac) - Local Whisper dictation for macOS<br/>🛠️ [**fae-macos**](https://github.com/theos2node/fae-macos) - ARM64 Mach-O patcher for modded Factorio achievements<br/>🚀 [**iPadOS Inventory Taker**](https://github.com/theos2node/ipados-inventory-taker) - Barcode and photo-assisted inventory capture for iPad<br/>✏️ [**MAK o2**](https://github.com/theos2node/mak-o2) - Spatial PencilKit canvas for sketch-first notes<br/>🗺️ [**RSSICartographer**](https://github.com/theos2node/RSSICartographer) - Local distance mapping using Wi-Fi for Mac<br/>📺 [**Chrome2Airplay**](https://github.com/theos2node/Chrome2Airplay) - AirPlay from Chrome through a native macOS helper<br/>
